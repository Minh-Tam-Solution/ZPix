...
| 2 | Test FLUX.2-klein-4B load + generate on MPS | US-1.2 | @coder | **Done** |
| 3 | Test LoRA hot-swap on MPS | US-1.3 | @coder | **Done** |
| 4 | Test image-to-image workflow on MPS | US-1.4 | @coder | **Done** |
| 5 | Write benchmark script (automate 11 configs from test plan) | US-1.1 | @architect | **Done** |
| 6 | Run benchmark suite, collect results | US-1.1 | @tester | **Done** |
| 7 | Write benchmark-results.md with recommendations | US-1.1 | @architect | **Done** |
| 8 | PR/report findings to OGA local-server | US-1.1 | @architect | **Done** |
